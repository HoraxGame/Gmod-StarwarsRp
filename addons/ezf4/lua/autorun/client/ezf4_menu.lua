...
local function ezf4menu()
	...
	for k, v in pairs(commandbutton) do
		...
		commandbuttons.DoClick = function()
			...
			if commandbutton[k].selldoors == true then
				LocalPlayer():ConCommand( "darkrp sellalldoors" )
				if IsValid(bg) then
					bg:Remove()
				end
			end
			...
			if commandbutton[k].addlaw == true then
				local cbg = vgui.Create( "DFrame" )
				cbg:SetSize( 300, 150 )
				cbg:Center()
				cbg:SetTitle( "" )
				...
				cbg.Paint = function(self, w, h)
					...
					draw.RoundedBox( 0, 0, 0, w, 35, EZF4.SideBarColor )
					draw.DrawText( commandbutton[k].name, "EZF4Titles", w / 2, 5, EZF4.ButtonTextColorHover, TEXT_ALIGN_CENTER )
					draw.DrawText( "LAW NAME?", "EZF4Titles", w / 2, 55, EZF4.CommandInfo, TEXT_ALIGN_CENTER )
				end
				...
				ctext:SetText( "" )
				ctext.OnEnter = function()
					LocalPlayer():ConCommand( "darkrp addlaw " .. ctext:GetValue() ) 
					if IsValid(cbg) then
						cbg:Remove()
					end
					if IsValid(bg) then
			...
			if commandbutton[k].removelaw == true then
				local cbg = vgui.Create( "DFrame" )
				cbg:SetSize( 300, 150 )
				cbg:Center()
				cbg:SetTitle( "" )
				...
				cbg.Paint = function(self, w, h)
					...
					draw.RoundedBox( 0, 0, 0, w, 35, EZF4.SideBarColor )
					draw.DrawText( commandbutton[k].name, "EZF4Titles", w / 2, 5, EZF4.ButtonTextColorHover, TEXT_ALIGN_CENTER )
					draw.DrawText( "LAW NUMBER?", "EZF4Titles", w / 2, 55, EZF4.CommandInfo, TEXT_ALIGN_CENTER )
				end
				...
				ctext:SetText( "" )
				ctext.OnEnter = function()
					LocalPlayer():ConCommand( "darkrp removelaw " .. ctext:GetValue() ) 
					if IsValid(cbg) then
						cbg:Remove()
					end
					if IsValid(bg) then
